...
public class Steganography
{
	...
	public boolean encode(String path, String original, String ext1, String stegan, String message)
	{
		...
		return(setImage(image,new File(image_path(path,stegan,ext1)),ext1));
	}
	 ...
	 *@param type integer representing either basic or advanced encoding
	 */
	public String decode(String path, String name, String ext)
	{
		...
		try
		{
			...
			BufferedImage image  = user_space(getImage(image_path(path,name,ext)));
	...
	private boolean setImage(BufferedImage image, File file, String ext)
	{
		...
		{
                    System.out.println("Image set error : " + e.getMessage());
			JOptionPane.showMessageDialog(null,
